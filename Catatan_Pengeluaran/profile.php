                    ...
                    <hr>
                        <form class="form" method="post" action="" enctype='multipart/form-data'>
                            ...
                            <div class="input-group col-md mb-3 mt-3">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="profilepic">Upload Foto</label>
                                </div>
                                <div class="input-group-append">
                                    <button class="btn btn-secondary" type="submit" name='but_upload' id="profilepicinput">Upload Foto</button>
                                </div>
                            </div>
                        ...
                        <form class="form" action="" method="post" id="registrationForm" autocomplete="off">
                            ...
                            <div class="form-group">
                                <div class="col-md">
                                    <br>
                                    <button class="btn btn-block btn-md btn-success" style="border-radius:0%;" name="save" type="submit">Simpan</button>
                                </div>
                            </div>
                        </form>
                        <!--/tab-content-->
